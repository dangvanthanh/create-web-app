...
module.exports = co.wrap(function* (options) {
  ...
  _.log()
  _.log(chalk.green(figlet.textSync('Create Web App', {
    font: 'Standard',
  ...
  const kopyOptions = {
    filters: {
      'src/html/index.html': 'html === "nunjucks"',
  ...
  _.log(chalk.green('- To get started:'))
  _.log(`\n  cd ${merged.name}\n`)
  _.log(chalk.green('- To watch for development:'))
  _.log('\n  npm run dev\n')
  _.log(chalk.green('- To build for production:'))
  _.log('\n  npm run build\n')
})
